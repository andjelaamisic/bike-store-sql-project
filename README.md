...
📊 SQL Analytics Projects – Bike Store Dataset
Project Overview

This repository contains a collection of SQL analytics projects created using the Bike Store sample database.
The purpose of these projects is to practice and demonstrate SQL skills by analyzing sales, products, categories, and customer behavior in a realistic business scenario.

The analyses focus on tracking performance, identifying trends, segmenting data, and creating reports that support business decision-making.

Dataset:
Bike Store sample database (fictional sales, product, and customer data used for learning and portfolio projects).
...
Business-oriented KPIs and segmentation

Project Purpose

Practice analytical SQL on a realistic dataset
...
Build dashboards for product and sales performance

Extend analysis with customer lifetime value (CLV) or retention metrics
